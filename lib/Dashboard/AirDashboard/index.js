...
var AirDashboard = function (_Component) {
  ...
  _createClass(AirDashboard, [{
    ...
    value: function draw(value) {
      ...
      var grd = this.ctx.createLinearGradient(0, this.props.radius, this.props.radius * 2, this.props.radius);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: Object.assign({}, styles.value, this.props.valueStyle) },
            this.props.value
          ),
          _react2.default.createElement(
            'div',
...
var Point = function (_Component2) {
  ...
  function Point(props) {
    ...
    _this3.createAnimate = _this3.createAnimate.bind(_this3);
    _this3.createAnimate();
    _this3.state = {
      css: {
        left: _this3.left,
        top: _this3.top,
    ...
    _this3.timeOutHandle = null;

    _this3.transitionEnd = _this3.transitionEnd.bind(_this3);
    _this3.transitionEvent = _this3.whichTransitionEvent();
    return _this3;
  }
