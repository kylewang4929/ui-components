...
class Knob extends Component {
  ...
  constructor(props) {
    ...
    //判断点击事件类型
    this.hasTouch = 'ontouchstart' in window, this.startEvent = this.hasTouch ? 'touchstart' : 'mousedown';
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            targetValue,
            React.createElement('sup', { className: 'transparent-text', style: styles.unit })
          )
        ),
        React.createElement(
          'div',
      ...
      React.createElement(
        ...
        Array(this.calibrationLength).fill(0).map((item, index) => {
          ...
          return React.createElement(
            ...
            React.createElement('div', { style: styles.innerItem })
          );
        })
      )
    );
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('div', { style: pointStyles.inner })
      )
    );
  }
}
