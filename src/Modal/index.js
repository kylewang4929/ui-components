...
class Loading extends Component {
  render() {
    return (
      <Overlay style={this.props.overlayStyle} onClose={this.props.onClose} isShow={this.props.isShow}>
        <LoadingContent isShowIcon={this.props.isShowIcon} content={this.props.content}></LoadingContent>
      </Overlay>
    );
  }
}
  ...
  render() {
    return (
      <div style={styles.loadingBox}>
        ...
        <div style={styles.loadingText}>{this.props.content}</div>
      </div>
    );
  }
}
...
class Overlay extends Component {
  ...
  render() {
    ...
    return (
      <div className="modal" ref={c => {this.overlayDom = c;}} onClick={this.handleClick} style={Object.assign({}, styles.overlay, style, this.props.style)}>
