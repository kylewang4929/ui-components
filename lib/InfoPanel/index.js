  ...
  _createClass(InfoPanel, [{
    ...
    value: function render() {
      ...
      if (infoData.length > 2) {
        lineDom = [_react2.default.createElement('div', { style: _extends({}, styles.verticalLine, lineStyle) }), _react2.default.createElement('div', { style: _extends({}, styles.horizontalLine) })];
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          data.map(function (item, index) {
            ...
            return _react2.default.createElement(
              'div',
              { style: _extends({}, styles.item, padding), key: 'infoitem' + index },
              _react2.default.createElement(
                'div',
